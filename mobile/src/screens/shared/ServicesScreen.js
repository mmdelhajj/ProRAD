...
const serviceRowStyles = StyleSheet.create({
  container: { marginHorizontal: 6, marginBottom: 3 },
  row: {
    flexDirection: 'row',
    backgroundColor: colors.surface,
    borderRadius: borderRadius.sm,
  ...
  info: { flex: 1 },
  name: { fontSize: 12, fontWeight: '700', color: colors.text, marginBottom: 1 },
  speed: { fontSize: 13, color: colors.textSecondary, marginBottom: 3 },
  tagsRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 2 },
  tag: {
  ...
  rightSide: { justifyContent: 'center', alignItems: 'flex-end', marginLeft: 6 },
  price: { fontSize: 12, fontWeight: '700', color: colors.text, marginBottom: 1 },
  chevron: { fontSize: 15, fontWeight: '700', color: colors.textLight },
});
